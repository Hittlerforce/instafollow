...
echo -e "\e[1;92mHittler family Alex Prince official Instagram Id Farhadali0072"
...
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] It can increase your followers up to about +40 in 1 hour \e[0m\n"
...
momgerm="36382772"
zuck="72936392"
rafaelyaredoficial="263837383"
afiune_caio="1937383378"
kallmedrado="48282938"
tierry="932829288"
aliaabhatt="232829292"
khaby00="29272838"
maluma="7292728"
jlo="29473838"
giulia="19383922"
willsmith="139639392"
thekidlaroi="72927393829"
Instagramforbusiness="629282933839"
meta="927383737"
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Auto to follow Hittler trick %s ..." $celeb
...
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Auto to unfollow Hittler Trick %s ..." $celeb
